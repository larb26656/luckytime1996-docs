...
แต่ถ้าเรากำหนดให้การเลือก DropdownMenuItem จะเปิด dialog จะพบปัญหาแล้วกดปุ่มปิด dialog มันจะไม่ยอมลบ `pointer-events: none;` ออกจาก body

<ChatMessage message="เข้าใจว่าปัญหาพอเลือกเมนูแล้วเปิด dialog มันไม่ปิด dropdown menu state เลยค้าง"  avatarKey="blackCat" />

**Solution 1:**
เราสามารถปิด dropdown menu ก่อนกดปุ่มปิด dialog ได้
...
**Solution 2:**
เราสามารถปิด ปรับ model จาก true เป็น false ได้เพื่อไม่ให้ dropdown menu มัน ใส่pointer-events: none;
